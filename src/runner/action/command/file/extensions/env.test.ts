...
describe('Set Env File Command Test', () => {
  ...
  it('simple multiLines file', async () => {
    ...
    const putContentExecutor = runner.container!.putContent(rootDirectory, {
      name: 'simple-file',
      body: ['', 'MY_ENV=MY VALUE', '', 'MY_ENV_2=my second value'].join(os.EOL),
    });
    putContentExecutor.execute();
  ...
  it('simple multiLines with empty value', async () => {
    ...
    const putContentExecutor = runner.container!.putContent(rootDirectory, {
      name: 'simple-file',
      body: ['MY_ENV=MY VALUE', 'MY_ENV_2=', 'MY_ENV_3=my third value'].join(os.EOL),
    });
    putContentExecutor.execute();
  ...
  it('simple multiLines with special char', async () => {
    ...
    const putContentExecutor = runner.container!.putContent(rootDirectory, {
      name: 'simple-file',
      body: ['MY_ENV==abc', 'MY_ENV_2=def=ghi', 'MY_ENV_3=jkl='].join(os.EOL),
    });
    putContentExecutor.execute();
  ...
  it('blockList items filtered heredoc', async () => {
    ...
    const putContentExecutor = runner.container!.putContent(rootDirectory, {
      name: 'simple-file',
      body: ['NODE_OPTIONS<<EOF', 'asdf', 'EOF'].join(os.EOL),
    });
    putContentExecutor.execute();
  ...
  it('heredoc', async () => {
    ...
    const putContentExecutor = runner.container!.putContent(rootDirectory, {
      name: basename,
      body: ['MY_ENV<<EOF', 'line one', 'line two', 'line three', 'EOF'].join(os.EOL),
    });
    putContentExecutor.execute();
  ...
  it('heredoc Empty Value', async () => {
    ...
    const putContentExecutor = runner.container!.putContent(rootDirectory, {
      name: basename,
      body: ['MY_OUTPUT<<EOF', 'EOF'].join(os.EOL),
    });
    putContentExecutor.execute();
  ...
  it('heredoc Skip Empty Lines', async () => {
    ...
    const putContentExecutor = runner.container!.putContent(rootDirectory, {
      name: basename,
      body: ['MY_OUTPUT<<EOF', 'hello', 'world', 'EOF', '', 'MY_OUTPUT_2<<EOF', 'HELLO', 'AGAIN', 'EOF'].join(os.EOL),
    });
    putContentExecutor.execute();
  ...
  it('heredoc Missing NewLine', async () => {
    ...
    const putContentExecutor = runner.container!.putContent(rootDirectory, {
      name: basename,
      body: ['MY_OUTPUT<<EOF', 'line one', 'line two', 'line three', 'EOF'].join(' '),
    });
    putContentExecutor.execute();
