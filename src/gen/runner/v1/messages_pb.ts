...
export type TaskState = Message<'runner.v1.TaskState'> & {
  ...
  /**
   * @generated from field: repeated runner.v1.Issue issues = 6;
   */
  issues: Issue[];
};
...
export type StepState = Message<'runner.v1.StepState'> & {
  ...
  /**
   * @generated from field: repeated runner.v1.Issue issues = 7;
   */
  issues: Issue[];
};
...
export type Issue = Message<'runner.v1.Issue'> & {
  ...
  /**
   * file/line/col/stepNumber/logFileLineNumber...
   *
...
export enum IssueType {
  ...
  /**
   * @generated from enum value: ISSUE_TYPE_ERROR = 1;
   */
  ERROR = 1,

  /**
   * @generated from enum value: ISSUE_TYPE_WARNING = 2;
   */
  WARNING = 2,

  /**
   * @generated from enum value: ISSUE_TYPE_NOTICE = 3;
   */
  NOTICE = 3,
}
