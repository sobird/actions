...
describe('uses-reusable-workflow test', () => {
  ...
  it('remote other repository reusable workflow test case', async () => {
    const uses = new Uses(
      'sobird/actions-test/.gitea/workflows/test-reusable-workflow.yml@115f40b9fca317e4b0fec9af66b35d7a37ee69f8',
    );
  ...
  it('remote reusable workflow with https test case', async () => {
    const uses = new Uses(
      'https://gitea.com/sobird/actions-test/.gitea/workflows/test-reusable-workflow.yml@115f40b9fca317e4b0fec9af66b35d7a37ee69f8',
    );
